      ...
      {product ? (
        <section className="product-detail"  typeof="schema:Product">
          <Helmet>
            ...
            <meta name="og:description" content={product.description.slice(0,160)} />
            <meta name="og:title" content={product.title} />
            <meta property="og:url" content={window.location.href} />
            <script className='structured-data-list' type="application/ld+json">{structuredDataSingle(product)}</script>
          </Helmet>
